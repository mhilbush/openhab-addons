...
public class SunsetWxHandler extends BaseThingHandler {
    ...
    private void scheduleUpdateQualityJob() {
        ...
        cancelUpdateQualityJob();
        updateQualityJob = scheduler.scheduleWithFixedDelay(this::refreshQuality, 10L,
                configRefreshIntervalMinutes * 60, TimeUnit.SECONDS);
    }
    ...
    private void updateQualityChannels(FeatureContainerDTO fc) {
        ...
        updateState(CHANNEL_QUALITY_PERCENT, new DecimalType(String.valueOf(qualityPercentAverage)));
        updateState(CHANNEL_QUALITY_VALUE, new DecimalType(String.valueOf(qualityValueAverage)));
