...
public class SunsetWxDiscoveryService extends AbstractDiscoveryService
    ...
    public SunsetWxDiscoveryService() {
        super(SUPPORTED_SUNSETWX_THING_TYPES_UIDS, 20, true);
    }
    ...
    private synchronized void discoverThings() {
        ...
        ThingUID sunriseThingUID = new ThingUID(THING_TYPE_UID_SUNRISE, bridgeUID, "forecast");
        ThingUID sunsetThingUID = new ThingUID(THING_TYPE_UID_SUNSET, bridgeUID, "forecast");
        //
